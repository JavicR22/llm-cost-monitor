...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      {/* Right: Form */}
      <div className="relative flex w-1/2 flex-col items-center justify-center bg-[#1E293B] px-12">
        {/* Top accent line */}
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-base text-[#94A3B8]">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm font-medium text-[#60A5FA] hover:text-[#3B82F6]"
              >
                Forgot password?
              </Link>
            </div>
